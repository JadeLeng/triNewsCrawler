...
public class MainActivity extends InstrumentedActivity implements OnClickListener{
    ...
    private void initView(){
        ...
        mSetting = (Button)findViewById(R.id.gowebview);
        mSetting.setOnClickListener(this);

        myWebViewbtn = (Button)findViewById(R.id.gowebview);
        myWebViewbtn.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.gowebview:
                ...
                // Use remote resource
                mWebView.loadUrl("http://120.24.57.3/triNewsCrawler/web/");
    ...
    public static final String MESSAGE_RECEIVED_ACTION = "com.example.apple.newsweb.MESSAGE_RECEIVED_ACTION";
